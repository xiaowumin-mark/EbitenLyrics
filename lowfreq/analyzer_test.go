...
func TestAnalyzerPrefersBassOverHighFrequency(t *testing.T) {
	const sampleRate = 48000
	const sampleCount = 2048
	bassAnalyzer := NewAnalyzer(sampleRate)
	highAnalyzer := NewAnalyzer(sampleRate)
...
func TestAnalyzerKeepsBassAboveMidrange(t *testing.T) {
	const sampleRate = 48000
	const sampleCount = 2048
	bassAnalyzer := NewAnalyzer(sampleRate)
	vocalAnalyzer := NewAnalyzer(sampleRate)
...
func TestAnalyzerBoostsTransientRise(t *testing.T) {
...
func TestAnalyzerKickBurstRaisesQuickly(t *testing.T) {
	analyzer := NewAnalyzer(48000)
...
func TestAnalyzerBassUsesPracticalRange(t *testing.T) {
	analyzer := NewAnalyzer(48000)
...
func TestAnalyzerAcceptsMonoFloatSamples(t *testing.T) {
	analyzer := NewAnalyzer(48000)
...
func TestAnalyzerAcceptsFloat32Samples(t *testing.T) {
	analyzer := NewAnalyzer(48000)
...
func TestAnalyzerSmallPacketStillProducesValue(t *testing.T) {
	analyzer := NewAnalyzer(48000)
...
func TestAnalyzerSilenceStaysLow(t *testing.T) {
	analyzer := NewAnalyzer(48000)
