...
import (
	...
	"github.com/xiaowumin-mark/EbitenLyrics/lowfreq"
...
func WSAudioFallbackEnabled() bool {
	return wsAudioFallback.Load()
}

func SetWSAudioFallbackEnabled(enabled bool) {
	wsAudioFallback.Store(enabled)
}
...
type lowFreqAnalyzer struct{ inner *lowfreq.Analyzer }

func newLowFreqAnalyzer(sampleRate float64) *lowFreqAnalyzer {
	return &lowFreqAnalyzer{inner: lowfreq.NewAnalyzer(sampleRate)}
}
...
func (a *lowFreqAnalyzer) AnalyzePCM(data []byte) (float64, bool) {
	...
	return a.inner.AnalyzePCM(data)
}

func (a *lowFreqAnalyzer) AnalyzeFloat32(data []float32) (float64, bool) {
	if a == nil || a.inner == nil {
		return 0, false
	}
	return a.inner.AnalyzeFloat32(data)
}

func (a *lowFreqAnalyzer) AnalyzeMonoSamples(samples []float64, format string) (float64, bool) {
	if a == nil || a.inner == nil {
		return 0, false
	}
	return a.inner.AnalyzeMonoSamples(samples, format)
}
